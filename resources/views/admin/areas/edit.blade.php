...
@section('content')
    ...
    <div id="app" class="col-lg-12">
        <h1 class="page-header">Editar Area: {{$area->name}}</h1>
        ...
        <form method="POST" action="{{route('admin.supplies-categories.store')}}">
            ...
            <div class="row">
                ...
                <div class="col-xs-2 col-sm-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input  style="padding: 32px !important;"  type="checkbox" @if($area->touch)checked="checked"@endif data-toggle="toggle" data-on="Touch <i class='fa fa-hand-pointer-o fa-fw'></i>" id="mode" name="mode"
                ...
                <div class="col-xs-2 col-sm-2 col-md-2">
                    <div class="form-group">
                        ...
                        <input disabled style="padding: 32px !important;" @if($area->multiple==0)checked="checked"@endif type="checkbox" data-toggle="toggle" data-on="Simple <i class='fa fa-user fa-fw'></i>" id="type" name="type"
            ...
            <div v-if="multiple" class="row">
                ...
                <div class="col-md-12">
                    ...
                    <table v-else class="table table-striped table-bordered" style="table-layout: fixed;">
                        ...
                        <tr>
                            <th>Subarea</th>
                            <th>Codigo</th>
                            <th style="width: 138px">Editar</th>
                ...
                <div class="col-md-12" v-if="multiple">
                    <button style="margin-top: 14px" type="button" @click="saveChanges()" class="btn btn-success btn-lg"><i class="fa fa-floppy-o fa-fw"></i>Guardar Cambios</button>
                </div>
            </div>
        </form>
    ...
    <script>
        var app = new Vue({
            ...
            mounted: function(){
                ...
                this.oldData = <?php echo $area ?>;


                this.childs = <?php echo $area->getChilds ?>;

                for(i=0;i<this.childs.length;i++)
                {
                    this.childs[i].showpassword = false;
                }

                this.name = this.oldData.name;
                this.description = this.oldData.description;
                this.selectedIcon = this.oldData.icon_id;
                this.multiple = this.oldData.multiple;
                this.mode = this.oldData.touch;
                this.selectedIcon = this.oldData.icon_id;
