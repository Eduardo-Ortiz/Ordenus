...
<div id="app">
    ...
    <div class="container">
        <div style="text-align: center;">
            <span style="font-weight: 700;font-size: 32px;color: #f7b630">MENU ORDENUS</span>

            <div style="margin-top: 3px">
                <span style="font-size: 20px;font-weight: 300;margin-top: 5px">Variedad de platillos en el menu de ordenus.</span>
            </div>
